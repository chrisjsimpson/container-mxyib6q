...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mxyib6q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mxyib6q.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-mxyib6q.git
cd container-mxyib6q
```
...
```
docker attach container-mxyib6q
```
